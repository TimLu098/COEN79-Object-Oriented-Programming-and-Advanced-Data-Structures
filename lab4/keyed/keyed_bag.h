...
//     keyed_bag::value_type is the data type of the items in the keyed_bag. It may
// be any of
...
//     Postcondition: If key was in the keyed_bag, then the key and its value have 
//been removed;
...
//keyed_bags)
//     share no keys.
//     Postcondition: Each item and its key in addend has been added to this 
// keyed_bag.
//
//
...
// both this bag and the "otherBag". In other words, this function checks if there is 
